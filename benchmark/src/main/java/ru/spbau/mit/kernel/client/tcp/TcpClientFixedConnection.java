...
public class TcpClientFixedConnection extends Client {
    private static final Logger logger = Logger.getLogger(TcpClientFixedConnection.class.getName());
    private Socket socket = null;

    public TcpClientFixedConnection(String serverIp, Configuration config) {
